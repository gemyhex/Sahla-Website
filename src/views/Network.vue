            ...
            <b-tabs pills vertical class="tab-list">
              <b-tab v-for="(tab, i) in tabs" :key="i" :title="tab">
                <v-row align="center" class="">
                  ...
                  <v-col cols="6" xl="2" lg="3" md="4" sm="4" class="item-lvl">
                    <div class="item">
                      <div class="logo">
                        <v-img
                          src="@/assets/images/net1.png"
                          alt="TradeLine"
                          max-width="210px"
                          height="137px"
                          contain
